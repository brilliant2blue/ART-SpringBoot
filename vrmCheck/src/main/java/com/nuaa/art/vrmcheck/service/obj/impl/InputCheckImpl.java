...
import com.nuaa.art.vrmcheck.service.obj.InputCheck;
...
public class InputCheckImpl implements InputCheck {
     ...
     */
    @Override
    public boolean checkInputIntegrityOfCondition(VariableRealationModel vrmModel, CheckErrorReporter errorReporter) {
     ...
     */
    @Override
    public boolean checkInputIntegrityOfEvent(VariableRealationModel vrmModel, CheckErrorReporter errorReporter) {
     ...
     */
    @Override
    public boolean checkInputIntegrityOfModeTrans(VariableRealationModel vrmModel, CheckErrorReporter errorReporter) {
...
//            System.out.println(modesInClass);
     ...
     */
    void checkInputIntegrity(VariableRealationModel vrmModel, TableOfVRM table, Boolean isEvent,CheckErrorReporter errorReporter){
