...
import com.nuaa.art.vrmcheck.service.table.OutputCheck;
...
public class OutputCheckImpl implements OutputCheck {
     ...
     */
    @Override
    public boolean checkOutputIntegrityOfCondition(VRM vrmModel, CheckErrorReporter errorReporter) {
     ...
     */
    @Override
    public boolean checkOutputIntegrityOfEvent(VRM vrmModel, CheckErrorReporter errorReporter) {
     ...
     */
    void checkOutputIntegrity(VRM vrmModel, TableOfVRM table, Boolean isEvent, CheckErrorReporter errorReporter){
